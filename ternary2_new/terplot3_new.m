...
% Make x-tick labels in reverse order
for i=1:number
    htick(i,1)=text(l(i),-0.025,num2str(1 - l(i))); % 아래쪽 축
    htick(i,3)=text(1 - l(i) * cos(pi/3) + 0.025, l(i) * sin(pi/3) + 0.025, num2str(1 - l(i))); % 오른쪽 축
    htick(i,2)=text(0.5 - l(i) * cos(pi/3) - 0.06, sin(pi/3) * (1 - l(i)), num2str(1 - l(i))); % 왼쪽 축
end
